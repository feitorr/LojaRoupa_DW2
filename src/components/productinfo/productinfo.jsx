...
class ProductInfo extends React.Component {
  ...
  addToBag = () => {
    if (tamanhosGlobal && corGlobal) {
      const item = { nome: "Casaco Corta Frio", image : "https://i.postimg.cc/2ShXTvgn/61059-08-001-5000x-png.webp", price: "29.99" , saldo : "40.00", tamanho: tamanhosGlobal, cor: corGlobal, quantidade: 1 };
